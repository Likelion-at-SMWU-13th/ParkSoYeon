...
const Restaurant: React.FC = () => {
  const [search, setSearch] = useState<string>("한식"); // 검색창
  const [restaurants, setRestaurants] = useState<RestaurantType[]>([]); // 음식점 목록

  useEffect(() => {
    axios
      .get<RestaurantType[]>("http://localhost:8000/restaurant")
      .then((res) => {
